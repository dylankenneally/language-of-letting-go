...
_When the time is right, child. When the time is right_. How often have we heard those words—from a friend, a sponsor, our Higher Power?
...
We try to predict, circling dates on the calendar, asking questions. We forget that we don't hold the answers. The answers come from God. If we listen closely, well hear them. _When the time is right, child. When the time is right_.
