...
They can be an indication that we are trying to control someone. They can be an indication that we are not believing how good we are, that we're good enough, that someone is
